...
(A [direct rip](https://github.com/bigchaindb/bigchaindb/blob/master/PYTHON_STYLE_GUIDE.md) from the [BigChainDB Project](https://github.com/bigchaindb/bigchaindb). So thanks to them!)
